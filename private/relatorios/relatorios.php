...
?>
    <tr>
        ...
        <td class="text-end">
            <a href="/gira/private/relatorios/exportar_relatorio.php?tipo=<?php echo $rep['tipo']; ?>" class="btn btn-primary btn-sm rounded-3 fw-bold shadow-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Gerar e Descarregar">
